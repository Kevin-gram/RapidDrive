...
export default function Companies() {
  return (
    <div className='bg-navy pb-10 sm:pt-24 md:pt-32 pt-52'>
      <h1 className='text-xl sm:text-3xl flex justify-center font-bold font-xyz  text-white py-10 md:mt-10'> Our Partners </h1>
